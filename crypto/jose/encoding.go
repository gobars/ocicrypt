...
func compress(algorithm gojose.CompressionAlgorithm, input []byte) ([]byte, error) {
	switch algorithm {
	case gojose.DEFLATE:
		return deflate(input)
	default:
		return nil, gojose.ErrUnsupportedAlgorithm
	}
}

// Perform decompression based on algorithm
func decompress(algorithm gojose.CompressionAlgorithm, input []byte) ([]byte, error) {
	switch algorithm {
	case gojose.DEFLATE:

...
import (
	...
	"github.com/gobars/ocicrypt/crypto/openpgp/s2k"
...
func hashToHashId(h x509.Hash) uint8 {
...
func Encrypt(ciphertext io.Writer, to []*Entity, signed *Entity, hints *FileHints, config *packet.Config) (plaintext io.WriteCloser, err error) {
	...
	candidateHashes := []uint8{
		hashToHashId(x509.SHA256),
		hashToHashId(x509.SHA384),
		hashToHashId(x509.SHA512),
		hashToHashId(x509.SHA1),
		hashToHashId(x509.RIPEMD160),
		hashToHashId(x509.SM3),
	}
